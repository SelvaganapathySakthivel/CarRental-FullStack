  ...
  return (
    <div>
      <motion.div
        ...
        <Title title='Available Cars' subTitel='Browse our selection of premium vechicles available for your next adventure' />
      ...
      <motion.div
        ...
        <p className='text-gray-500 xl:px max-w-7xl mx-auto'>Showing {filteredCars.length} Cars</p>
