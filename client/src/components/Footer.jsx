            ...
            <motion.div
                ...
                <div>
                    ...
                    <motion.p
                        ...
                        Premimum car rental service with a wide selection of luxuary and everday vechicles for all your driving needs.
                    </motion.p>
                    <motion.div
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                ...
                <motion.div
                    ...
                    <div>
                        ...
                        <ul className='mt-3 flex flex-col gap-1.5 '>
                            <li>Luxuary Cars Drive</li>
                            <li>Tiruppur, TamilNadu</li>
                            <li>+91 987-654-3210</li>
                            <li>selvaCars@gmail.com</li>
                        </ul>
                    </div>
