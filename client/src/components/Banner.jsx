...
const Banner = () => {
  return (
    ...
    className='flex flx-col md:flex-row md:items-start items-center justify-between px-8 min-mid:pl-14 pt-10 bg-gradient-to-r from-[#0558fe] to-[#a9cfff] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
      
        <div className='text-white'>
            <h2 className='text-3xl font-medium'>Do you Own a Luxury Car?</h2>
            <p className='mt-2'>Monetize your vechicle effortlessy by listining is on CarRental.</p>
